...
sudo pacman -S xorg-xwayland firefox-developer-edition wget zsh unrar docker
docker-compose smbclient playerctl file-roller blueman alacritty vlc zathura
zathura-cb zathura-pdf-mupdf thunderbird libreoffice-fresh libreoffice-fresh-nl thunar sway swaylock
swayidle
